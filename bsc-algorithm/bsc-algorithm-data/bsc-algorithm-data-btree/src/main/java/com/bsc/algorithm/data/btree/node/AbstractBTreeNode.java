...
public abstract class AbstractBTreeNode<K extends Comparable<K>> {
	 ...
	 *             if node is full
	 */
	public abstract void insertNotFull(K key);
	 ...
	 * </p>
	 * <p>
	 * If key to delete does not exist in current node,internal node will find a
	 * subtree tree the key may exist in,find the key in subtree and delete;the
	 * leaf will do nothing if the key to delete does not exist.
	 * </p>
	 * 
	 * @param key
	 *            the key to delete.
	 */
	public abstract void deleteNotEmpty(K key);

	/**
	 * <p>
	 * Insert a key in to B-Tree.
	 * </p>
	 * <p>
	 * Insert a key into current node.
	 * </p>
	 * 
	 * @param key
	 *            the key to insert
	 ...
	 * @throws java.lang.RuntimeException
	 *             if {@code idx < 0 } or {@code idx >= degree *2 -1}
	 */
	 ...
	 * @param index
	 *            index of child to insert
	 */
	public void insertChild(AbstractBTreeNode<K> sub, int index) {
		int i = this.nchild();
		while (i > index) {
	 ...
	 */
	public abstract AbstractBTreeNode<K> getChild(int index);

	/**
	 * Delete given child in current node.
	 * 
	 * @param child
	 *            child subtree to delete.
	 */
	 ...
	 * 
	 * @param child
	 *            child index to split
	 * @throws java.lang.RuntimeException
	 *             is child to spilt is not full
	 */
	public abstract void splitChild(int child);
	 ...
	 * 
	 * @param middle
	 *            middle key of the two node
	 * @param sibling
	 *            sibling node to merge
	 * @throws java.lang.RuntimeException
	 *             if keys of either node exceed degree-1.
	 */
	 ...
	 *            root of B-Tree.
	 * @param <K>
	 *            Type of key of B-Tree
	 * @return String of B-Tree.
	 */
	public static <K extends Comparable<K>> String BTreeToString(AbstractBTreeNode<K> root) {
		StringBuffer sb = new StringBuffer();
		AbstractBTreeNode<K> node;
		Queue<AbstractBTreeNode<K>> queue = new LinkedList<>();
		queue.add(root);
